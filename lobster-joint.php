<?php include('header.php'); ?>
	...
	<body class="brand-page lobster-joint-page">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-1">
							<h1>
								<a href="als-beef.php">
									<img src="public/images/thumbs/lobster-joint.png" alt="" title="" />
								</a>
							</h1>
						</div>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<img src="public/images/lobster-joint/slide1.jpg" />
					...
					<div class="col-md-12">
						<div class="col-md-11 col-md-offset-1">
							<ul>	
							    ...
							    <li class="swiper-pagination-switch ">
							    	<a href="#"><strong>Why</strong>Lobster Joint</a>
							    </li>
							</ul>
						</div>
					</div>
