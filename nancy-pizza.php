				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-1 col-xs-2">
							<h1>
								<a href="index.php">
									<img src="public/images/thumbs/nancy-pizza.png" alt="" title="" />
								</a>
							</h1>
						</div>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<img src="public/images/nancy-pizza/slide1.jpg" />
						...
						<div class="col-md-11 col-md-offset-1">
							<ul>	
							    ...
							    <li class="swiper-pagination-switch ">
							    	<a href="#"><strong>Why</strong>Nancy's Pizza</a>
							    </li>
							</ul>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="content align-left">
							...
							<div class="col-md-8">
								...
								<p class="lead">
									People passionate about Nancy's Pizza<br />
