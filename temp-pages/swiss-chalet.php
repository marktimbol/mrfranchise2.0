				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-1">
							<h1>
								<a href="#">
									<img src="<?=get_bloginfo('stylesheet_directory');?>/public/images/temp/swiss-chalet-logo-transparent.png" alt="" title="" />
								</a>
							</h1>
						</div>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<img src="<?=get_bloginfo('stylesheet_directory');?>/public/images/temp/swiss/slide1.jpg" />
					...
					<div class="swiper-content">	
						<div class="col-md-10">
							...
							<p><a href="#" class="btn btn-clear">Inquire now</a></p>
						</div>
					</div>
				...
				<div class="swiper-slide">
					<img src="<?=get_bloginfo('stylesheet_directory');?>/public/images/temp/swiss/slide2.jpg" />
					...
					<div class="col-md-12">
						<div class="col-md-10 col-md-offset-1">
							<ul>	
							    ...
							    <li class="swiper-pagination-switch ">
							    	<a href="#"><strong>Why</strong>Swiss Chalet</a>
							    </li>
							    <li class="swiper-pagination-switch ">
							    	<a href="#"><strong>What's</strong>New</a>
							    </li>						    
							</ul>
						</div>
					</div>
						...
						<div class="content align-left">
							<div class="col-md-2 col-md-offset-1">
					            <div class="logo-inquire">
					                <img src="<?=get_bloginfo('stylesheet_directory');?>/public/images/temp/swiss-chalet-logo-transparent.png" alt="" title="" />
					                <p><a class="btn btn-clear" href="#">Inquire now</a></p>
					            </div>
						   	</div>
